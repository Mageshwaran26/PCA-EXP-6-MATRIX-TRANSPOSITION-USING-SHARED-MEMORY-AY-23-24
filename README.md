...
```
## OUTPUT:
<img width="1741" height="385" alt="image" src="https://github.com/user-attachments/assets/1a11fa42-d3eb-4256-b9c4-3832505698ec" />


## RESULT:
Thus the program has been executed by using CUDA to transpose a matrix. It is observed that there are variations shared memory and global memory implementation. The elapsed times are recorded as as grid(1,1),block(16,16).
